        ...
        <div class="nk-sidebar">
            <div class="nk-nav-scroll">
                <ul class="metismenu" id="menu">
                    <li class="nav-label">View data</li>
                    <li>
                        <a class="has-arrow" href="javascript:void()" aria-expanded="true">
                            <i class="icon-speedometer menu-icon"></i><span class="nav-text">Seller Activities</span>
                        </a>
                        <ul aria-expanded="false">
                            ...
                            <li><a href='/dashboard-sellhistory'>Selling History</a></li>
                            <li><a href='/dashboard-alltrans'>All Transactions</a></li>
                            <li><a href='/dashboard-pendingamount'>Pending Amount</a></li>
                            <li>
                        <a class="has-arrow" href="javascript:void()" aria-expanded="false">
                            <i class="icon-envelope menu-icon"></i> <span class="nav-text">contact for problem</span>
                        </a>
                        <ul aria-expanded="false">
                            ...
                            <li><a href="./index.html">Settlement Report</a></li>
                    ...
                    <li>
                        <a class="has-arrow" href="javascript:void()" aria-expanded="true">
                            <i class="icon-speedometer menu-icon"></i><span class="nav-text">User Activities</span>
                        </a>
                        <ul aria-expanded="false">
                            <li><a href="./index.html">Orders</a></li>
                            <li><a href="./index.html">Reviews</a></li>
                            <li><a href="./index.html">Cancellation</a></li>
                            <li><a href="./index.html">Conatct Issue</a></li>
                            <li><a href="./index.html">Settlement report</a></li>
                            <li><a href="./index.html">Reason for returning product</a></li>
                            <li><a href="./index.html">Purchase History</a></li>
                        </ul>
                    </li>
                </ul>
            </div>
