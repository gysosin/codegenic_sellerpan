                    ...
                    <div class="form-input-content">
                        <div class="card login-form mb-0">
                            <div class="card-body pt-5">
                                ...
                                <form class="mt-5 mb-5 login-input" action='/register-upload' method='get'>
                                    ...
                                    <div class="form-group" id="rightbox">
                                        <input type="text" class="form-control" placeholder="Aadhar card" required>
                                    </div>

                                    <div class="form-group" id="rightbox">
                                        <input type="text" class="form-control" placeholder="Personal Pan Card" required>
                                    </div>
